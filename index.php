		...
		<main role="main" class="container">
		    <div class="container">
		        <div class="card card-container">
		        	<div class="text-center h3 mb-4">HRMIS</div>
		            ...
		            <form id="formLogin">
		                ...
		                <button class="btn btn-lg btn-secondary btn-block btn-signin" type="submit">Sign in</button>
		            </form><!-- /form -->
		        </div><!-- /card-container -->
		    </div><!-- /container -->
		</main>
			...
			$.ajax({
				...
				success: function(data){
					if(data == 1){
						...
						alert("Success! Press okay to continue...");
						window.location="main/index.php?page=<?=page_url('stocks')?>";
					}else{
