...
<html>
	...
	<body>		
		<nav class="navbar navbar-light sticky-top flex-md-nowrap p-0 shadow" style="background-color: #292928;">
		  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="dashboard.php"><h4 
		  style="margin-bottom: 0; font-weight: bold; color:white;">HRMIS</h4></a>
