<div class="main">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><a href="index.php?page=<?=page_url('dashboard')?>"> <span class="text-muted">Leave Transactions Department Head</span></h1>
        ...
        <form id="add_stock_form" method="POST" action="#">
          <div class="row">
            ...
            <div  class="col-8 offset-2 mb-3">
              ...
              <input type="text" name="lot_no" id = "lot_no" class="form-control" placeholder="Unit Cost" step=".01">
            </div>
      ...
      <div class="modal-body">
        <form id="edit_stock_form" method="POST" action="#">
          <div class="row">
            ...
            <div  class="col-8 offset-2 mb-3">
              <label>LOT number</label>
              <input type="text" name="lot_no" id = "e_lot_no" class="form-control" placeholder="Unit Cost" step=".01">
            </div>
